 ...
 * @author yupi
 */
public class MultiFileCodeFileSaverTemplate extends CodeFileSaverTemplate<MultiHtmlFileCodeResult> {
    ...
    @Override
    protected void saveFiles(MultiHtmlFileCodeResult result, String baseDirPath) {
        // 保存 HTML 文件
    ...
    @Override
    protected void validateInput(MultiHtmlFileCodeResult result) {
