 ...
 * @author yupi
 */
public class HtmlCodeFileSaverTemplate extends CodeFileSaverTemplate<SingleHtmlFileCodeResult> {
    ...
    @Override
    protected void saveFiles(SingleHtmlFileCodeResult result, String baseDirPath) {
        // 保存 HTML 文件
        writeToFile(baseDirPath, "index.html", result.getHtmlCode());
    }

    @Override
    protected void validateInput(SingleHtmlFileCodeResult result) {
